...
public class E26Activity extends AppCompatActivity {

    private static final String TAG = "E26";

    private Recette recette;
    private String nomSalle = "";
    private String callBaie = "";
    private String numEquip = "";
    private String ElevEquip = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_e26);
        ...
        if (intent != null) {
            ...
            TextView elevEquip = findViewById(R.id
                    .elevEquip);
            elevEquip.setText(ElevEquip);
        }
        ...
        buttonNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!allAnsweredQuestions) {
                    AlertDialog.Builder notAnswered = new AlertDialog.Builder(E26Activity.this);
                    ...
                    Intent intent1 = new Intent(E26Activity.this, RecapActivity.class);
